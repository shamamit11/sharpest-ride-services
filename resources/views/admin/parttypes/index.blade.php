...
<div class="content-page">
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <nav class="navbar navbar-light">
                                    ...
                                    <a href="{{route('admin-parttypes-add')}}" class="btn btn-primary my-2 my-sm-0 ms-1">
                                        Add</a>
                                </nav>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="tr{{ $row->id }}">
                                            ...
                                            <td style="text-align:center"><a
                                                    href="{{route('admin-parttypes-add', ['id='.$row->id])}}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <div class="float-end"> {{$parttypes->links('pagination::bootstrap-4')}} </div>
                                    </div>
                                </div>
                                @else
    ...
    $(document).ready(function() {
        $('.switch-status').change(function() {
            ...
            $.ajax({
                url: '{{ route("admin-parttypes-status")}}',
                type: 'POST',
                data: {
                    'id': id,
                    'val': val,
        ...
        $('.delete-row-btn').click(function() {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("admin-parttypes-delete")}}',
                        type: 'POST',
                        data: {
                            'id': id,
                            '_token': '{{ csrf_token() }}'
